  ...
  return (
    <div
      ...
      className={cn(
        ...
        // light mode. Default padding rhythm is space-5 (20px).
        "flex flex-col gap-5 rounded-card border border-line bg-card py-5 text-card-foreground shadow-none dark:shadow-card",
        className
      )}
      {...props}
    />
