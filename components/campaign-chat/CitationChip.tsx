...
export function CitationChip({
  ...
  return (
    <Link
      ...
      className="inline-flex items-center gap-1 rounded-full border border-line-subtle bg-surface-2 px-2.5 py-0.5 align-baseline font-mono text-[length:var(--text-caption)] font-medium tabular-nums text-fg-muted transition-colors hover:border-accent hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
