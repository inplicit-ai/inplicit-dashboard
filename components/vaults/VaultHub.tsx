...
export function VaultHub({
  ...
  const collections: Collection[] = [
    ...
    { key: "integrations", label: t("collIntegrations") },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      {collection === "roles" ? (
        ...
        <IntegrationsView vaultId={vaultId} />
      ) : isItemsEmpty ? (
...
function IntegrationsView({ vaultId }: { vaultId: string | null }) {
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 text-[length:var(--text-body-sm)] text-fg-muted">
              Überträgt Call-Transkripte automatisch in diesen Kontext-Ordner. Perfekt für
              Team-Calls mit Silas oder Kundengespräche.
            </p>
